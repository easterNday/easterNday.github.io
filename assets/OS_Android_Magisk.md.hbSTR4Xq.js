import{$ as a,U as s,S as n,as as p}from"./chunks/framework.7ON99jD9.js";const u=JSON.parse('{"title":"Magisk","description":"","frontmatter":{},"headers":[],"relativePath":"OS/Android/Magisk.md","filePath":"OS/Android/Magisk.md","lastUpdated":1704180282000}'),l={name:"OS/Android/Magisk.md"},i=p(`<h1 id="magisk" tabindex="-1">Magisk <a class="header-anchor" href="#magisk" aria-label="Permalink to &quot;Magisk&quot;">​</a></h1><p>Magisk是一个Android设备上的root解决方案和框架，它允许用户在保持设备完整性的同时获得root访问权限。Magisk通过在系统分区之外安装自己的文件和二进制文件来实现这一点，从而不会对设备进行任何物理修改，从而使用户能够安全地运行应用程序，例如银行应用程序或Google Pay，而不会失去其root权限。</p><h2 id="magisk的主要特点" tabindex="-1">Magisk的主要特点 <a class="header-anchor" href="#magisk的主要特点" aria-label="Permalink to &quot;Magisk的主要特点&quot;">​</a></h2><ul><li>安全：Magisk不会对设备进行物理修改，可以保持设备的完整性，同时还能获得root访问权限。</li><li>兼容性：Magisk可以与大多数Android设备和Android版本一起使用。</li><li>模块化：Magisk模块是由社区成员制作并共享的软件包，可以修改设备的系统、应用程序或用户体验，例如添加功能、优化性能或更改外观。</li><li>隐藏Root：Magisk可以隐藏root访问权限，以便在需要时保护用户的隐私和安全。</li><li>OTA更新：Magisk可以在OTA更新后自动重新安装，以便保持root访问权限和Magisk模块。</li><li>开源：Magisk是一个开源项目，可以在GitHub上查看其源代码。</li></ul><h2 id="magisk模块" tabindex="-1">Magisk模块 <a class="header-anchor" href="#magisk模块" aria-label="Permalink to &quot;Magisk模块&quot;">​</a></h2><h3 id="magisk模块的使用" tabindex="-1">Magisk模块的使用 <a class="header-anchor" href="#magisk模块的使用" aria-label="Permalink to &quot;Magisk模块的使用&quot;">​</a></h3><p>Magisk模块是由社区成员制作并共享的软件包，可以修改设备的系统、应用程序或用户体验。要使用Magisk模块，请按照以下步骤操作：</p><ol><li>打开Magisk Manager应用程序。</li><li>点击“模块”选项卡。</li><li>点击“浏览”按钮，并浏览可用的模块列表。</li><li>选择要安装的模块并点击“下载和安装”按钮。</li><li>安装完成后，重新启动设备。</li></ol><p>请注意，某些Magisk模块可能会对设备造成不可逆的损坏，因此请确保在安装任何模块之前备份您的设备并谨慎操作。</p><h3 id="magisk-模块结构" tabindex="-1">Magisk 模块结构 <a class="header-anchor" href="#magisk-模块结构" aria-label="Permalink to &quot;Magisk 模块结构&quot;">​</a></h3><p>Magisk 模块是放置在 <code>/data/adb/modules</code> 中的文件夹（一般而言），结构如下：</p><div class="language-txt vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/data/adb/modules</span></span>
<span class="line"><span>├── .</span></span>
<span class="line"><span>├── .</span></span>
<span class="line"><span>|</span></span>
<span class="line"><span>├── $MODID                  &lt;--- 文件夹以模块的 ID 命名</span></span>
<span class="line"><span>│   │</span></span>
<span class="line"><span>│   │      *** 模块 ID ***</span></span>
<span class="line"><span>│   │</span></span>
<span class="line"><span>│   ├── module.prop         &lt;--- 此文件存储模块的元数据（metadata）</span></span>
<span class="line"><span>│   │</span></span>
<span class="line"><span>│   │      *** 主要内容 ***</span></span>
<span class="line"><span>│   │</span></span>
<span class="line"><span>│   ├── system              &lt;--- 如果 skip_mount 不存在，将挂载此文件夹</span></span>
<span class="line"><span>│   │   ├── ...</span></span>
<span class="line"><span>│   │   ├── ...</span></span>
<span class="line"><span>│   │   └── ...</span></span>
<span class="line"><span>│   │</span></span>
<span class="line"><span>│   ├── zygisk              &lt;--- 此文件夹包含模块的 Zygisk native 库</span></span>
<span class="line"><span>│   │   ├── arm64-v8a.so</span></span>
<span class="line"><span>│   │   ├── armeabi-v7a.so</span></span>
<span class="line"><span>│   │   ├── x86.so</span></span>
<span class="line"><span>│   │   ├── x86_64.so</span></span>
<span class="line"><span>│   │   └── unloaded        &lt;--- 如果存在，则 native 库不兼容</span></span>
<span class="line"><span>│   │</span></span>
<span class="line"><span>│   │      *** 状态标志 ***</span></span>
<span class="line"><span>│   │</span></span>
<span class="line"><span>│   ├── skip_mount          &lt;--- 如果存在，Magisk 将不会挂载您的 system 文件夹</span></span>
<span class="line"><span>│   ├── disable             &lt;--- 如果存在，模块将被禁用</span></span>
<span class="line"><span>│   ├── remove              &lt;--- 如果存在，模块将在下次重新启动时删除</span></span>
<span class="line"><span>│   │</span></span>
<span class="line"><span>│   │      *** 可选文件 ***</span></span>
<span class="line"><span>│   │</span></span>
<span class="line"><span>│   ├── post-fs-data.sh     &lt;--- 此脚本将在 post-fs-data 中执行</span></span>
<span class="line"><span>│   ├── service.sh          &lt;--- 此脚本将在 late_start 服务中执行</span></span>
<span class="line"><span>|   ├── uninstall.sh        &lt;--- 当 Magisk 删除您的模块时，将执行此脚本</span></span>
<span class="line"><span>│   ├── system.prop         &lt;--- resetprop 将此文件中的属性作为系统属性加载</span></span>
<span class="line"><span>│   ├── sepolicy.rule       &lt;--- 其他自定义 sepolicy 规则</span></span>
<span class="line"><span>│   │</span></span>
<span class="line"><span>│   │      *** 自动生成，请勿手动创建或修改 ***</span></span>
<span class="line"><span>│   │</span></span>
<span class="line"><span>│   ├── vendor              &lt;--- $MODID/system/vendor 的符号链接</span></span>
<span class="line"><span>│   ├── product             &lt;--- $MODID/system/product 的符号链接</span></span>
<span class="line"><span>│   ├── system_ext          &lt;--- $MODID/system/system_ext 的符号链接</span></span>
<span class="line"><span>│   │</span></span>
<span class="line"><span>│   │      *** 允许任何其他文件/文件夹 ***</span></span>
<span class="line"><span>│   │</span></span>
<span class="line"><span>│   ├── ...</span></span>
<span class="line"><span>│   └── ...</span></span>
<span class="line"><span>|</span></span>
<span class="line"><span>├── 其他模块</span></span>
<span class="line"><span>│   ├── .</span></span>
<span class="line"><span>│   └── .</span></span>
<span class="line"><span>├── .</span></span>
<span class="line"><span>├── .</span></span></code></pre></div><h2 id="magisk-模块安装程序" tabindex="-1">Magisk 模块安装程序 <a class="header-anchor" href="#magisk-模块安装程序" aria-label="Permalink to &quot;Magisk 模块安装程序&quot;">​</a></h2><p>Magisk 模块安装程序是打包在 zip 文件中的 Magisk 模块，可以在 Magisk 应用程序或第三方recovery（如 TWRP）中刷入。最简单的 Magisk 模块安装程序只是一个打包为 zip 文件的 Magisk 模块，此外还有以下文件：</p><ul><li><code>update-binary</code>：下载最新的 <a href="https://github.com/topjohnwu/Magisk/blob/master/scripts/module_installer.sh" target="_blank" rel="noreferrer">module_installer.sh</a> 并将该脚本重命名或复制为 <code>update-binary</code></li><li><code>updater-script</code>：这个文件应该只包含字符串 “<code>#MAGISK</code>”</li></ul><p>模块安装程序脚本将会设置环境，将模块文件从 zip 文件提取到正确的位置，然后完成安装过程，这对于大多数简单的 Magisk 模块来说应该足够好了。</p><div class="language-txt vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>模块module.zip</span></span>
<span class="line"><span>│</span></span>
